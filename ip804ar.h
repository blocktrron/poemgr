...
/* The files ip804ar.c and ip804ar.h were moved from the files ip802ar.c and ip802ar.h added by @0xharshal. */
/* Some registry changes were made according to the ip804ar datasheet, most of them seem to be the same as ip802ar. */
...
#define IP804AR_REG_HW_REVISION_MSB 0x03
#define IP804AR_REG_HW_REVISION_LSB 0x04

#define IP804AR_PAGE_FORCE_POLL (0)
#define IP804AR_REG_FORCE_POLL (0xE2)
...
#define IP804AR_MASK_PORT_AFAT_MODE(port) BIT(port)
#define IP804AR_AF_MODE(port) 0
#define IP804AR_AT_MODE(port) BIT(port)
